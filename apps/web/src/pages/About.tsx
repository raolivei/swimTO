        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-300">
          ...
          <div className="prose prose-blue dark:prose-invert max-w-none">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li>
                🗺️ Interactive map view of community centers with lane swim
                sessions
              </li>
              <li>
                📅 Schedule browser with filtering by swim type, day, and
                location
              </li>
              <li>🔄 Data sourced from City of Toronto Open Data Portal</li>
              <li>
                📱 Responsive design optimized for mobile and desktop devices
              </li>
              <li>🌓 Dark mode support for comfortable viewing</li>
              <li>⭐ Save favorite facilities for quick access</li>
            </ul>
